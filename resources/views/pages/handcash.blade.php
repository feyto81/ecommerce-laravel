    ...
    <section>
        ...
        <div class="col-md-12">
        	<div class="row text-center">
        		<h3 class="text-center">Thanks For Order ,<span style="color: green;">{{$customer_name}}</span></h3>
        		<p>Kami Akan Mengirim Product Anda Jika Sudah Di setujui oleh owner toko kami.Kami akan mengirim product anda melalui Expedisi yang telah anda pilih.Anda Dapat mengecek product anda telah disetujui atau belum di menu my order,apabila order status success maka produk anda akan dikirim ,apabila order status pending berarti ada masalah pada pembayaran anda kami setelah 1 X 24 jam. </p>
        		<p></p>
        	</div>
        </div>
    </div>
