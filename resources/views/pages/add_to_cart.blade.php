			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="total_area">
						<ul>
							<li>Cart Sub Total <span>Rp.{{Cart::subtotal()}}</span></li>
							<li>Eco Tax <span>Rp.{{Cart::tax()}}</span></li>
							...
							<?php if($customer_id !=NULL){?>
                                     <br><li><a href="{{URL::to('/checkout')}}"><i class="btn btn-success btn-sm" style="margin-left: 20px">Checkout</i></a>
                                     </li>
